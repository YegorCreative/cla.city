...
echo "2. Use <picture> elements in pages: webp/ source + jpg fallback"
echo "3. Visually verify the 10 unverified images listed in data/image-map.json"
echo "4. Delete or archive the original numbered source files once done"
echo ""
